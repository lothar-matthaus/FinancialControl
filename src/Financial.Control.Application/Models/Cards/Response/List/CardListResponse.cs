...
{
    public sealed class CardListResponse : BaseResponse<ISuccessResponse<ICardModel>, IErrorResponse, ICardModel>, ICardListResponse
    {
        public CardListResponse() { }
        private CardListResponse(string message, HttpStatusCode statusCode, ISuccessResponse<ICardModel> success) : base(message, statusCode, success) { }
        private CardListResponse(string message, HttpStatusCode statusCode, IErrorResponse error) : base(message, statusCode, error) { }

        #region Factory
        public static CardListResponse AsSuccess(string message, HttpStatusCode statusCode, ISuccessResponse<ICardModel> success) => new CardListResponse(message, statusCode, success);

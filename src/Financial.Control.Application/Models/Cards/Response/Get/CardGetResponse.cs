...
{
    public sealed class CardGetResponse : BaseResponse<ISuccessSingleResponse<ICardModel>, IErrorResponse, ICardModel>, ICardGetResponse
    {
        public CardGetResponse() { }

        public CardGetResponse(string message, HttpStatusCode statusCode, ISuccessSingleResponse<ICardModel> success) : base(message, statusCode, success) { }
        public CardGetResponse(string message, HttpStatusCode statusCode, IErrorResponse error) : base(message, statusCode, error) { }

        #region Factory
        public static CardGetResponse AsSuccess(string message, HttpStatusCode statusCode, ISuccessSingleResponse<ICardModel> success) => new CardGetResponse(message, statusCode, success);

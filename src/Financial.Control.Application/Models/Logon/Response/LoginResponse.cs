...
{
    public class LoginResponse : BaseResponse<ISuccessResponse<ILoginModel>, IErrorResponse, ILoginModel>, ILoginResponse
    {
        public LoginResponse() { }

        private LoginResponse(string message, HttpStatusCode statusCode, ISuccessResponse<ILoginModel> success) : base(message, statusCode, success) { }
        private LoginResponse(string message, HttpStatusCode statusCode, IErrorResponse error) : base(message, statusCode, error) { }

        public static LoginResponse AsSuccess(string message, HttpStatusCode statusCode, ISuccessResponse<ILoginModel> success) => new LoginResponse(message, statusCode, success);

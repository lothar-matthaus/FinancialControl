...
{
    public sealed class RevenueListResponse : BaseResponse<ISuccessResponse<IRevenueModel>, IErrorResponse, IRevenueModel>, IRevenueListResponse
    {
        public RevenueListResponse() { }
        private RevenueListResponse(string message, HttpStatusCode statusCode, ISuccessResponse<IRevenueModel> success) : base(message, statusCode, success) { }
        private RevenueListResponse(string message, HttpStatusCode statusCode, IErrorResponse error) : base(message, statusCode, error) { }

        #region Factory
        public static RevenueListResponse AsSuccess(string message, HttpStatusCode statusCode, ISuccessResponse<IRevenueModel> success) => new RevenueListResponse(message, statusCode, success);

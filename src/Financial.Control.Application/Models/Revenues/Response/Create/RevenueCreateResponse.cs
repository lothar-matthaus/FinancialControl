...
{
    public class RevenueCreateResponse : BaseResponse<ISuccessResponse<IRevenueModel>, IErrorResponse, IRevenueModel>, IRevenueCreateResponse
    {
        public RevenueCreateResponse() { }
        private RevenueCreateResponse(string message, HttpStatusCode statusCode, ISuccessResponse<IRevenueModel> success) : base(message, statusCode, success) { }
        ...
        #region Factory
        public static RevenueCreateResponse AsSuccess(string message, HttpStatusCode statusCode, ISuccessResponse<IRevenueModel> success) => new RevenueCreateResponse(message, statusCode, success);

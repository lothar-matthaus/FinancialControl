...
{
    public sealed class UserUpdatePasswordResponse : BaseResponse<ISuccessSingleResponse<IUserModel>, IErrorResponse, IUserModel>, IUserUpdateResponse
    {
        public UserUpdatePasswordResponse() { }
        private UserUpdatePasswordResponse(string message, HttpStatusCode statusCode, ISuccessSingleResponse<IUserModel> success) : base(message, statusCode, success) { }
        ...
        #region MyRegion
        public static UserUpdatePasswordResponse AsSuccess(string message, HttpStatusCode statusCode, ISuccessSingleResponse<IUserModel> success) => new UserUpdatePasswordResponse(message, statusCode, success);

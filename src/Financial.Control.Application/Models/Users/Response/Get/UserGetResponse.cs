...
{
    public class UserGetResponse : BaseResponse<ISuccessSingleResponse<IUserModel>, IErrorResponse, IUserModel>, IUserGetResponse
    {
        public UserGetResponse()
        {
        }

        public UserGetResponse(string message, HttpStatusCode statusCode, ISuccessSingleResponse<IUserModel> success) : base(message, statusCode, success)
        {
        }
        ...
        #region Factory
        public static UserGetResponse AsSuccess(string message, HttpStatusCode statusCode, ISuccessSingleResponse<IUserModel> success) => new UserGetResponse(message, statusCode, success);

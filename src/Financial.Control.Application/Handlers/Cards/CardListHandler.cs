...
{
    public class CardListHandler : AppRequestHandler<CardListRequest, CardListResponse>
    {
        ...
        public async override Task<CardListResponse> Handle(CardListRequest request)
        {

...
namespace Financial.Control.Infra.Data.Migrations
{
    ...
    [Migration("20230407192533_alteracao_default_value_tabela_user_colunas_de_data")]
    partial class alteracao_default_value_tabela_user_colunas_de_data
    {
            ...
            modelBuilder.Entity("Financial.Control.Domain.Entities.User", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDate")
                        ...
                        .HasDefaultValue(new DateTime(2023, 4, 7, 16, 25, 33, 533, DateTimeKind.Local).AddTicks(7716));
                    ...
                    b.Property<DateTime>("UpdateDate")
                        .ValueGeneratedOnUpdate()
                        .HasColumnType("timestamp")
                        .HasDefaultValue(new DateTime(2023, 4, 7, 16, 25, 33, 533, DateTimeKind.Local).AddTicks(9620));
